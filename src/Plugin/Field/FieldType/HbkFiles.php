...
class HbkFiles extends FileItem {
    ...
    //     $element["image_extensions"]["#default_value"] = $settings["image_extensions"] ?? "";
    //     $element["video_extensions"]["#default_value"] = $settings["video_extensions"] ?? "";
